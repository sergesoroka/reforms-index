    ...
    <>
      ...
      <Head>
        ...
        <meta
          ...
          content={metadata.data[3].meta.description}
        />
        <meta itemProp="image" content={metadata.data[3].meta.image} />
        {/* <meta property="og:url" content={window.location.href} /> */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content={metadata.data[3].meta.title} />
        <meta
          property="og:description"
          content={metadata.data[3].meta.description}
        />
        <meta property="og:image" content={metadata.data[3].meta.image} />
        <meta property="og:image:type" content="png" />
        <meta property="og:image:width" content="630" />
        <meta property="og:image:height" content="331" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={metadata.data[3].meta.title} />
        <meta
          name="twitter:description"
          content={metadata.data[3].meta.description}
        />
        <meta name="twitter:image" content={metadata.data[3].meta.image} />
